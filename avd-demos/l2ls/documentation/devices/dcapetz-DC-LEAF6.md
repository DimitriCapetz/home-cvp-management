...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | management | 10.99.99.9/24 | 10.99.99.1 |
...
| --------- | --------------- | ------------ | --------- |
| RACK3 | Vlan4094 | 10.255.255.254 | Port-Channel551 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | SERVER_DC-HOST3_eth2 | *access | *30 | *- | *- | 1 |
| Ethernet49/1 | L2_dcapetz-DC-SPINE1_Ethernet6/1 | *trunk | *30,40 | *- | *- | 491 |
| Ethernet50/1 | L2_dcapetz-DC-SPINE2_Ethernet6/1 | *trunk | *30,40 | *- | *- | 491 |
| Ethernet55/1 | MLAG_dcapetz-DC-LEAF5_Ethernet55/1 | *trunk | *- | *- | *MLAG | 551 |
| Ethernet56/1 | MLAG_dcapetz-DC-LEAF5_Ethernet56/1 | *trunk | *- | *- | *MLAG | 551 |
...
!
interface Ethernet1
   description SERVER_DC-HOST3_eth2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet49/1
   description L2_dcapetz-DC-SPINE1_Ethernet6/1
   no shutdown
   channel-group 491 mode active
!
interface Ethernet50/1
   description L2_dcapetz-DC-SPINE2_Ethernet6/1
   no shutdown
   channel-group 491 mode active
!
interface Ethernet55/1
   description MLAG_dcapetz-DC-LEAF5_Ethernet55/1
   no shutdown
   channel-group 551 mode active
!
interface Ethernet56/1
   description MLAG_dcapetz-DC-LEAF5_Ethernet56/1
   no shutdown
   channel-group 551 mode active
```
...
| Port-Channel551 | MLAG_dcapetz-DC-LEAF5_Port-Channel551 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel551
   description MLAG_dcapetz-DC-LEAF5_Port-Channel551
   no shutdown
   switchport mode trunk
