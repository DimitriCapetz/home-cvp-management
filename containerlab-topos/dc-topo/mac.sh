...
sudo cp ../cv-onboarding-token-stg clab-dc-topo/DC-SPINE1/flash/cv-onboarding-token
sudo cp ../cv-onboarding-token-stg clab-dc-topo/DC-SPINE2/flash/cv-onboarding-token
sudo cp ../cv-onboarding-token-stg clab-dc-topo/DC-LEAF1/flash/cv-onboarding-token
sudo cp ../cv-onboarding-token-stg clab-dc-topo/DC-LEAF2/flash/cv-onboarding-token
sudo cp ../cv-onboarding-token-stg clab-dc-topo/DC-LEAF3/flash/cv-onboarding-token
sudo cp ../cv-onboarding-token-stg clab-dc-topo/DC-LEAF4/flash/cv-onboarding-token
sudo cp ../cv-onboarding-token-stg clab-dc-topo/DC-LEAF5/flash/cv-onboarding-token
sudo cp ../cv-onboarding-token-stg clab-dc-topo/DC-LEAF6/flash/cv-onboarding-token
sudo cp ../cv-onboarding-token-stg clab-dc-topo/DC-BORDER1/flash/cv-onboarding-token
sudo cp ../cv-onboarding-token-stg clab-dc-topo/DC-BORDER2/flash/cv-onboarding-token