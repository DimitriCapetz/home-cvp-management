...
sudo cp ../cv-onboarding-token clab-evpn-dc-topo/DC1-SPINE1/flash/cv-onboarding-token
sudo cp ../cv-onboarding-token clab-evpn-dc-topo/DC1-SPINE2/flash/cv-onboarding-token
sudo cp ../cv-onboarding-token clab-evpn-dc-topo/DC1-LEAF1/flash/cv-onboarding-token
sudo cp ../cv-onboarding-token clab-evpn-dc-topo/DC1-LEAF2/flash/cv-onboarding-token
sudo cp ../cv-onboarding-token clab-evpn-dc-topo/DC1-LEAF3/flash/cv-onboarding-token
sudo cp ../cv-onboarding-token clab-evpn-dc-topo/DC1-LEAF4/flash/cv-onboarding-token
sudo cp ../cv-onboarding-token clab-evpn-dc-topo/DC1-BORDER1/flash/cv-onboarding-token
sudo cp ../cv-onboarding-token clab-evpn-dc-topo/DC1-BORDER2/flash/cv-onboarding-token
sudo cp ../cv-onboarding-token clab-evpn-dc-topo/DC2-SPINE1/flash/cv-onboarding-token
sudo cp ../cv-onboarding-token clab-evpn-dc-topo/DC2-SPINE2/flash/cv-onboarding-token
sudo cp ../cv-onboarding-token clab-evpn-dc-topo/DC2-LEAF1/flash/cv-onboarding-token
sudo cp ../cv-onboarding-token clab-evpn-dc-topo/DC2-LEAF2/flash/cv-onboarding-token
sudo cp ../cv-onboarding-token clab-evpn-dc-topo/DC2-LEAF3/flash/cv-onboarding-token
sudo cp ../cv-onboarding-token clab-evpn-dc-topo/DC2-LEAF4/flash/cv-onboarding-token
sudo cp ../cv-onboarding-token clab-evpn-dc-topo/DC2-BORDER1/flash/cv-onboarding-token
sudo cp ../cv-onboarding-token clab-evpn-dc-topo/DC2-BORDER2/flash/cv-onboarding-token
sudo cp ../cv-onboarding-token clab-evpn-dc-topo/DC3-SPINE1/flash/cv-onboarding-token
sudo cp ../cv-onboarding-token clab-evpn-dc-topo/DC3-SPINE2/flash/cv-onboarding-token
sudo cp ../cv-onboarding-token clab-evpn-dc-topo/DC3-LEAF1/flash/cv-onboarding-token
sudo cp ../cv-onboarding-token clab-evpn-dc-topo/DC3-LEAF2/flash/cv-onboarding-token
sudo cp ../cv-onboarding-token clab-evpn-dc-topo/DC3-LEAF3/flash/cv-onboarding-token
sudo cp ../cv-onboarding-token clab-evpn-dc-topo/DC3-LEAF4/flash/cv-onboarding-token
sudo cp ../cv-onboarding-token clab-evpn-dc-topo/DC3-BORDER1/flash/cv-onboarding-token
sudo cp ../cv-onboarding-token clab-evpn-dc-topo/DC3-BORDER2/flash/cv-onboarding-token